  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [
        ...
        supabase.from('completed_projects_view')
          .select('contractor_name, contractor_sigle')
      ]);
        ...
        <Col xs={24} md={8}>
          ...
          >
            <div style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                <Text>Domains</Text>
                <Text strong>{stats.totalDomains}</Text>
              </div>
              <Progress 
                percent={100} 
                strokeColor="#722ed1"
            ...
            <div style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                ...
                <Text strong>{stats.totalSubdomains}</Text>
              </div>
              <Progress 
                percent={100} 
                strokeColor="#13c2c2"
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                ...
                <Text strong>{stats.totalCategories}</Text>
              </div>
              <Progress 
                percent={100} 
                strokeColor="#eb2f96"
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <Text strong style={{ color: '#52c41a' }}>Create New Project</Text>
                </div>
              </div>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <Text strong style={{ color: '#1890ff' }}>View Recent Projects</Text>
                </div>
              </div>
